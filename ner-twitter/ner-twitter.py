# -*- coding: utf-8 -*-
"""twitter_BEST_BERT.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hKMBa2k5tD92kPoLxxUeB0uE7rHDKXud
"""
...
train = pandas_reader('/content/drive/MyDrive/190I/HW4/twitter/train.csv')
val = pandas_reader('/content/drive/MyDrive/190I/HW4/twitter/validation.csv')
test = pandas_reader('/content/drive/MyDrive/190I/HW4/twitter/test_noans.csv')

unique_labels = set(['B-company','B-facility','B-geo-loc','B-movie','B-musicartist','B-other','B-person','B-product','B-sportsteam', 'B-tvshow', 'I-company', 'I-facility', 'I-geo-loc', 'I-movie', 'I-musicartist', 'I-other', 'I-person', 'I-product', 'I-sportsteam', 'I-tvshow', 'O'])
...
#creation of BERT model using bert-base BERT
...
def train_BERT(model, df_train, df_val):
    ...
    #Adam is a kind of SGD optimizer that incorporates adaptive learning rates
...
#best hyperparameters for Adam optimizer
LEARNING_RATE = 5e-5
EPOCHS = 6
BATCH_SIZE = 32
...
#same as align_label except here our max_length is 512
...
#prints out num of labels that have token 20 and num of labels that don't have token 20
count_of_20 = 0
count_non_20 = 0
for i in results:
  if i == 20:
